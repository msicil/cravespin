...
struct GooglePlacesService: PlacesServicing {
    ...
    func fetchRestaurants(
        ...
        request.setValue(
            "places.id,places.displayName,places.formattedAddress,places.location,places.rating,places.priceLevel,places.currentOpeningHours,places.businessStatus,places.photos,places.reservable,places.websiteUri,places.googleMapsUri,places.primaryType,places.types",
