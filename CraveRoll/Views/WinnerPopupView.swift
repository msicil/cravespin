...
struct WinnerPopupView: View {
    ...
    private var shareButton: some View {
        let message = GoogleMapsLinker.shareMessage(for: restaurant)
        let subject = Text("Dinner pick: \(restaurant.name)")

        if let url = GoogleMapsLinker.shareURL(for: restaurant) {
            ShareLink(item: url, subject: subject, message: Text(message)) {
                shareButtonLabel
            }
            .buttonStyle(WinnerGhostButtonStyle())
        } else {
            ShareLink(item: message, subject: subject, message: Text(message)) {
                shareButtonLabel
            }
            .buttonStyle(WinnerGhostButtonStyle())
        }
    ...
    private var shareButtonLabel: some View {
        Label("Share Pick", systemImage: "square.and.arrow.up")
    ...
    private var reserveButtonLabel: some View {
